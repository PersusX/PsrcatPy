...
QPushButton:hover{
    ...
    def retranslateUi(self):
        ...
        self.label.setText(_translate("widget", "共2个参数"))
        self.prelabel.setText(_translate("widget", "共2个参数"))
        ...
        self.music_tabWidget.setTabText(self.music_tabWidget.indexOf(self.currentListWidget), _translate("widget", "选择列表"))
