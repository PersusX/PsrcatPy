...
#lb_info{
    ...
    '''
    def __init__(self, parent=None, text='', imagePath='../Resource/xing.png', aspectRatio=1):
...
#btn_more:hover{
    ...
    '''
    def __init__(self, parent=None,titleName='脉冲星参数',row=2, col=5, aspectRatio=1):
    ...
    def setupUi(self):
        ...
        for i in range(self.row):  # 默认两行
            for j in range(self.col):
                ...
                self.vly.setContentsMargins(0, 0, 0, 0)
                imageInfo = CImageInfo(self, aspectRatio=self.aspectRatio)
